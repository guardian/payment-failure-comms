...
object SalesforceConnector {
  ...
  def getRecordsToProcess(
    ...
    val query =
      ...
      |  Initial_Payment__r.Zuora__GatewayResponseCode__c,
      |  Initial_Payment__r.Zuora__GatewayResponse__c,
      ...
      |  Billing_Account__r.Zuora__BillToPostalCode__c,
      |  Billing_Account__r.Zuora__BillToAddress1__c,
      |  Billing_Account__r.Zuora__BillToAddress2__c,
      |  Billing_Account__r.Zuora__BillToCity__c,
